...
%-------------------------------------------------------------------------%
subplot(2,2,[3,4])   
plot(tout(1:i),xout(1:i,2), 'LineWidth',1);
...
axis([0 max(tout) -1 max(xout(:,2))+1])
...
plot(Toe_coords_des(:,1), Toe_coords_des(:,2),'.','MarkerSize',1,'Color', [0.9290, 0.6940, 0.1250]);
hold on
...
plot(Toe_coords(i,1), Toe_coords(i,2),'ko','MarkerSize',7,'MarkerFaceColor',[1, 1, 1]);
plot(Toe_coords_des(i,1), Toe_coords_des(i,2),'ko','MarkerSize',7,'MarkerFaceColor',[0.8500, 0.3250, 0.0980]);
hold off
ylabel('y (m)') 
xlabel('x (m)') 
...
plot(Toe_coords_des(:,3), Toe_coords_des(:,4),'.','MarkerSize',1,'Color', [0.9290, 0.6940, 0.1250]);
hold on
...
plot(Toe_coords(i,3), Toe_coords(i,4),'ko','MarkerSize',7,'MarkerFaceColor',[1, 1, 1]);
plot(Toe_coords_des(i,3), Toe_coords_des(i,4),'ko','MarkerSize',7,'MarkerFaceColor',[0.8500, 0.3250, 0.0980]);
hold off
ylabel('y (m)') 
xlabel('x (m)') 
...
plot(Toe_coords_des(:,5), Toe_coords_des(:,6),'.','MarkerSize',1,'Color', [0.9290, 0.6940, 0.1250]);
hold on
...
plot(Toe_coords(i,5), Toe_coords(i,6),'ko','MarkerSize',7,'MarkerFaceColor',[1, 1, 1]);
plot(Toe_coords_des(i,5), Toe_coords_des(i,6),'ko','MarkerSize',7,'MarkerFaceColor',[0.8500, 0.3250, 0.0980]);
hold off
ylabel('y (m)') 
xlabel('x (m)') 
...
plot(Toe_coords_des(:,7), Toe_coords_des(:,8),'.','MarkerSize',1,'Color', [0.9290, 0.6940, 0.1250]);
hold on
...
plot(Toe_coords(i,7), Toe_coords(i,8),'ko','MarkerSize',7,'MarkerFaceColor',[1, 1, 1]);
plot(Toe_coords_des(i,7), Toe_coords_des(i,8),'ko','MarkerSize',7,'MarkerFaceColor',[0.8500, 0.3250, 0.0980]);
hold off
ylabel('y (m)') 
xlabel('x (m)') 
